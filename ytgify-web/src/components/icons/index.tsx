...
export function HomeIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
...
export function TrendingIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function PlusCircleIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function BellIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function UserIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function HeartIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function CommentIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function BookmarkIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function FolderIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function LockIcon({ size = 24, filled, ...props }: IconProps) {
  if (filled) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" {...props}>
